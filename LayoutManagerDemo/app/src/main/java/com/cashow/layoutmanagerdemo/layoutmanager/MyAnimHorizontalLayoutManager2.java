 ...
 */
public class MyAnimHorizontalLayoutManager2 extends LayoutManager {
    // 水平偏移量
    ...
    public MyAnimHorizontalLayoutManager2() {
     ...
     * 根据滑动值改变View的UI状态
     */
    private void changeViewUIProperty(View child) {
        ...
        float fraction = distance * 5f / getWidth() / 2;
