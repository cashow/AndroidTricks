...
public class Chapter_1_5_Activity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addMyDemoView(new AfterOnDrawView(context), INFO_0);
        addMyDemoView(new BeforeOnDrawView(context), INFO_1);
        addMyDemoView(new BeforeDispatchDrawView(context), INFO_2);
        addMyDemoView(new AfterDispatchDrawView(context), INFO_3);
        addMyDemoView(new OnDrawForegroundView(context), INFO_4);
        addMyDemoView(new BeforeOnDrawForegroundView(context), INFO_5);
        addMyDemoView(new AfterOnDrawForegroundView(context), INFO_6);
        addMyDemoView(new BeforeDrawView(context), INFO_7);
    }
