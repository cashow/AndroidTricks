...
public class Chapter_1_8_Activity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        layoutContainer.addView(new HardwareRotate1View(context));
        addDivider();
        layoutContainer.addView(new HardwareRotate2View(context));
        addDivider();
        layoutContainer.addView(new HardwareLayerPaintView(context));
    }
