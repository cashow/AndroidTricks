...
public class AnimatorSet2View extends ImageView {
    ...
    public AnimatorSet2View(Context context) {
        super(context);
        init();
    }

    public AnimatorSet2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AnimatorSet2View(Context context, AttributeSet attrs, int defStyleAttr) {
